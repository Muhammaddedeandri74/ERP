...
<body>
	<form action="<?php echo base_url('MasterDataControler/addcard') ?>" method="POST" enctype="multipart/form-data">
		<div class="container-xxl text-white pt-3" style="background-color: purple;">
			<div class="row d-flex justify-content-between">
				...
				<div class="col-7">
					<p class="tu font-weight-bold " style="font-size: 13px">Admin/BANK/Buat Baru</p>
					<p class="tu font-weight-bold upc" style="font-size: 25px">Tambah Bank Baru</p>
				</div>
				<div class="col-4">
				</div>
			</div>
				...
				<div class="col-12 bays">
					<div class="biodata">
						...
						<div class="row" style="margin-top: 10px">
							...
							<div class="col">
								<input type="text" name="nocard" class="form-control" required>
							</div>
						</div>
						<div class="row" style="margin-top: 10px">
							<div class="col">
