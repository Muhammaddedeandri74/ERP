								...
								<div class="col-4">
									...
									<div class="row mb-3">
										<div class="col-10">
											...
											<div class="col">
												<input name="sku" type="text" id="sku" value="<?php echo $data["sku"] ?>" class="form-control" autocomplete="off" required>
											</div>
										</div>
										<div class="col-2"></div>
									</div>
								...
								<div class="col-4">
									<div class="row mb-3" id="bomx">
										<div class="col-10">
											...
											<div class="col">
												<input name="stokmin" type="text" id="stokmin" class="form-control" value="<?php echo $data["minstock"] ?>" autocomplete="off" required>
											</div>
										</div>
										<div class="col-2"></div>
									</div>
