		...
		<div class="col-12 bays">
			<div class="biodata">
				...
				<div class="row">
					<div class="col-1"></div>
					<div class="col-4"></div>
					<div class="col-2">Code Item Type</div>
				 ...
				 <div class="row mb-2">
					...
					<div class="col-4"></div>
					<div class="col-2">
				    <input type="text" name="codeitem" class="form-control" value="<?php echo $data['codecomm'] ?>" required readonly>
				 ...
				 <div class="row">
					<div class="col-1"></div>
					<div class="col-4"></div>
					<div class="col-2">Nama Item Type</div>
				...
				<div class="row">
					...
					<div class="col-4"></div>
					<div class="col-2">
				      <input type="text" name="itemname" class="form-control" value="<?php echo $data['namecomm'] ?>" required>
					</div>
				 </div>
						...
						<?php foreach ($data1 as $key) : ?>
							<tr>
								...
								<?php } else { ?>
									<td>No-Active</td>
								<?php } ?>
								<td><a href="<?php echo base_url('MasterDataControler/getdataitemtypebyid?id=' . base64_encode($key['codecomm'])) ?>" class="btn btn-primary">Edit</a></td>
							</tr>
						<?php endforeach ?>
					<?php endif ?>
                  </tbody>
