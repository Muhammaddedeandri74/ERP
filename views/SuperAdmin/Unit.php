<div class="container-xxl ml-5" style="width: 96%;">
	<div class=" row">
		<div class="col py-3" style="border-radius: 5px;">
			<h1 style="margin-top: 30px; margin-left: 20px;text-transform: uppercase;">Unit</h1>
						...
						<div class="row">
							<div class="col" style="margin-top: 10px; margin-left: 30px">
								<div class="row">
									...
									<p>Anda bisa mengatur (Tambah, Hapus, Aktif, non-Aktif) Unit untuk sistem ERP disini.</p>
								</div>
								<div class="row" style="margin-top: 20px">
									<div class="col">
										...
										<div class="row">
											<p><?php echo $active ?> Unit</p>
										</div>
									</div>
									<div class="col">
										<div class="row">
											<p><b>Unit Non-Aktif</b></p>
										</div>
										<div class="row">
											<p><?php echo $noactive ?> Unit</p>
										</div>
									</div>
									<div class="col">
										<div class="row">
										...
										<div class="row">
											<p><?php echo $active + $noactive ?> Unit</p>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row" style=" margin-left:20px;margin-right:10px;margin-top: 20px">
				<div class="col-9">
					<div class="row">
						<div class="col">
							<p class="col-4 pt-3" style="border-bottom: 5px solid purple; font-size: 22px">List Unit</p>
						</div>
						<div class="col pt-3">
							<a href="<?php echo base_url('SuperAdminControler/addunit') ?>" class="btn mt-2" style="float :right;border:1px solid purple;color:purple;">+ Tambah Unit</a>
						</div>
					</div>
				</div>
			</div>
					...
					<table style="width: 100% ; margin-top: 20px" class="table">
						<thead>
							<tr>
								...
								<th style="color: purple">ID Unit</th>
								<th style="color: purple">Name Unit</th>
							...
							<?php if ($data != "Not Found") { ?>
								...
								foreach ($data as $key) : ?>
									...
									<tr>
										...
										<?php } ?>
										<td><a href="<?php echo base_url('MasterDataControler/getdataunitbyid?id=' . base64_encode($key['codecomm'])) ?>" class="btn btn-secondary">Edit</a>
									</tr>
								<?php endforeach ?>
							<?php } ?>
						</tbody>
