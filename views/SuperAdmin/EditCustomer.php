				...
				<div class="row mb-2">
					<div class="col-4"></div>
					  <div class="col-4">
						  ...
						  <input type="text" name="codecustomer" class="form-control" value="<?php echo $data['codecomm'] ?>" required readonly>
				...
				<div class="row mb-2">
					<div class="col-4"></div>
					  <div class="col-4">
						  ...
						  <input type="text" name="namecomm" value="<?php echo $data["namecomm"]?>" class="form-control">
					  </div>
				</div>
				...
				<div class="row mb-2">
					<div class="col-4"></div>
					  <div class="col-4">
						  ...
						  <input type="email" name="email" value="<?php echo $data["attrib3"]?>" class="form-control" autocomplete="off" required>
					  </div>
				</div>
				...
				<div class="row mb-2">
					<div class="col-4"></div>
					  <div class="col-4">
						  ...
						  <input type="text" name="telepon" value="<?php echo $data["attrib2"]?>" class="form-control" autocomplete="off" required>
					  </div>
				</div>
				...
				<div class="row mb-2">
					<div class="col-4"></div>
					  <div class="col-4">
						  ...
						  <input type="text" name="contact" value="<?php echo $data["attrib5"]?>" class="form-control">
					  </div>
				</div>
				...
				<div class="row mb-2">
					<div class="col-4"></div>
					  <div class="col-4">
						  ...
						  <textarea name="alamat" id="" cols="5" rows="3" class="form-control"><?php echo $data["attrib1"]?></textarea>
					  </div>
				</div>
