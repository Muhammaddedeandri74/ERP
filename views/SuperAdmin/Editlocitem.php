...
<body style="overflow-x: hidden;">
    <form action="<?php echo base_url('MasterDataControler/editlockitem') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12 bays">
                    <div class="biodata">
                        ...
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col">
                                <input type="text" name="codecomm" class="form-control" value="<?php echo $data['codecomm'] ?>" required readonly>
                        ...
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col">
                                <input type="text" name="namecomm" value="<?php echo $data["namecomm"] ?>" class="form-control" required>
                                <input type="hidden" name="userid" class="form-control" value="<?php echo $iduser ?>">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col">
                                <input type="text" name="attrib1" class="form-control" value="<?php echo $data["attrib1"] ?>">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col">
                            ...
                            <div class="col">
                                <input type="text" name="attrib2" class="form-control" value="<?php echo $data["attrib2"] ?>">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col">
                            ...
                            <div class="col">
                                <input type="text" name="attrib3" class="form-control" value="<?php echo $data["attrib3"] ?>">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col">
                            ...
                            <div class="col">
                                <input type="text" name="attrib4" class="form-control" value="<?php echo $data["attrib4"] ?>">
                            </div>
                        </div>
