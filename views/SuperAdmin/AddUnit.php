...
<body>
	<form action="<?php echo base_url('MasterDataControler/addunit') ?>" method="POST" enctype="multipart/form-data">
		<div class="container-xxl text-white pt-3" style="background-color: purple;">
			<div class="row d-flex justify-content-between">
				...
				<div class="col-7">
					<p class="tu font-weight-bold " style="font-size: 13px">Admin/Unit/Buat Baru</p>
					<p class="tu font-weight-bold upc" style="font-size: 25px">Tambah Unit Baru</p>
				</div>
				<div class="col-4">
				</div>
			</div>
