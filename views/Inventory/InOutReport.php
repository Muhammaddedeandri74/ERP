           ...
           <div class="d-flex mb-3" style="align-items: flex-end;">
             ...
             <div class="" style="width:50%;">
                  ...
                  <select name="" id="" class="form-select">
                      ...
                      <option value="BahanMaterial">BahanMaterial</option>
                  </select>
             </div>
           </div>
          </div>
        ...
        <table class="table table-bordered table-striped list-akses" id="table-user">
		  <thead>
				<tr>
					...
					<td style="background:#1143d8;color:white;text-align:center;min-width: auto;">Spesifikasi</td>
					<td style="background:#1143d8;color:white;text-align:center;min-width: auto;">Item Type</td>
					<td style="background:#1143d8;color:white;text-align:center;min-width: auto;">SKU</td>
					<td style="background:#1143d8;color:white;text-align:center;min-width: auto;">QTY In</td>
					<td style="background:#1143d8;color:white;text-align:center;min-width: auto;">QTY Out</td>
					<td style="background:#1143d8;color:white;text-align:center;min-width: auto;">Balance</td>
				</tr>
			</thead>
            <tbody>
				<?php if($data !="Not Found"):?>
