<form action="<?php echo base_url('MasterDataControler/addpo') ?>" method="POST" enctype="multipart/form-data" id="form">
    <div class="header px-4 pt-2" style="height: 196px;">
        <nav aria-label="breadcrumb">
            ...
            <h3 class="text-white">Inventory Closing</h3>
        </nav>
    </div>
    <div class="content bg-white  mx-4">
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                ...
                <div class="col-4">
                    <div class="row">
                        <label for="" class="form-label fs-3 mb-3">Periode Closing</label>
                        <div class="col-4">
                ...
                <div class="col-4 text-end">
                    <a href="" class="btn px-4" data-mdb-toggle="modal" data-mdb-target="#exampleModal" style="background-color: #E6ECFF;text-transform: capitalize"><i class='bx bx-list-ul'></i> List Closing Hisotry</a>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-4">
