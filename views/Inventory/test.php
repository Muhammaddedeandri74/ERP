...
<form action="<?php echo base_url('InventoryOutControler/AddInventoryout') ?>" method="POST" enctype="multipart/form-data" id="form">
            ...
            <div class="row mb-4">
                ...
                <div class="col-4" id="other">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <button class="btn btn-light" onclick="printDiv('invout')"><i class='bx bx-printer'>Cetak</i></button>
                        </div>
                        <div class="col-6"></div>
                    </div>
                </div>
    ...
    <div class="card bay" style="display:none ;" id="invout">
        ...
        <div class="card-body">
            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="col text-center mt-3">
                    <label for="" class="form-label fs-3"><u>Inventory Out</u> </label>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
