...
<nav aria-label="breadcrumb">
  ...
  <h3 class="text-white">Edit Ingoing</h3>
</nav>
</div>
	...
	<div class="row no-gutters">
		<div class="col-12 bays">
			<div class="biodata">
				...
				<div class="row">
                      <div class="col d-flex align-middle" style="align-items:center;marign-right:auto;">
				     	<a style="text-decoration:none;color:black;" href="<?php echo base_url('AuthControler/mainpage')?>"></a>
                      </div>
                      <div class="col-2">
                          <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                           <label for="" style="font-size:20px;">Informasi Dasar</label>
                    </div>
                    ...
                    <div class="col-4">
                       <label for="" class="mb-2">Keterangan Due Date :</label><br>
                       <label for="" style="font-size:13px;">Permintaan harus dikirim 3 hari sebelum due date </label>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-1">
                    ...
                    <div class="col-2">
                      <a href="" class="btn btn-primary"><i class='bx bx-detail'></i> &nbsp;Ambil Data Purchase</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-1">
                    ...
                    <div class="col-2">
                    <label for="" class="mb-2">No Po :</label><br>
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-2">
                           <label for="" style="font-size:20px;">Item/Produk</label>
                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        <thead class="border-0">
                            ...
                            <th style="background:#1143d8;color:white;">Qty Order</th>
                            <th style="background:#1143d8;color:white;">Expired Date</th>
                            <th style="background:#1143d8;color:white;">Qty In</th>
                            <th style="background:#1143d8;color:white;">Balance</th>
                ...
                <div class="row">
                    ...
                    <div class="col-2"></div>
                    <div class="col-3">
                      <button type="submit" class="btn btn-primary" style="float: right; margin-top: 30px; padding-left:24px;padding-right:24px;font-size:19px;">Buat Transaksi</button>
                    </div>
                </div>
			</div>
		</div>
	    ...
	    <script>
			...
			// 	"order":[],
			// 	"ajax" :{
			// 		"url" :"<?php base_url('SuperAdminControler/get_json') ?>",
			// 		"type" : "POST"
			// 	},
			// 	"columns" :[
