	...
	<form action="<?php echo base_url('PrQuo/updatepr') ?>" method="POST" id="form">
		<div class="container-fluid text-white pt-3" style="background-color: orange;">
			<div class="row d-flex justify-content-between">
				...
				<div class="col-7">
					<p class="tu font-weight-bold " style="font-size: 13px">Gudang/Request/Detail Request</p>
					<p class="tu font-weight-bold upc" style="font-size: 25px">DETAIL REQUEST</p>
				</div>
				<div class="col-4">
				</div>
			</div>
		...
		<div class="container-fluid">
			<div class="row d-flex justify-content-between" style="margin-top: 2vh;padding-left:1rem">
				<div class="col-9 bays p-4">
					<p style="font-size: 30px;"><b>INFORMASI DASAR</b></p>
					<hr style="height: 0.2%">
					<div class="row d-flex justify-content-between">
						<div class="col-6">
							<div class="mb-3">
								<p style="font-size: 20px"><b>Info Permintaan</b></p>
							...
							<div class="mb-3">
								...
								<select class="form-select" name="idsupp" id="idsupp">
						...
						<div class="col-6">
							<div class="mb-3">
								<p style="font-size: 20px"><b>Pembayaran & Diskon</b></p>
								<hr style="height: 2%; background: orange; opacity: 1">
							</div>
							<div class="mb-3">
				...
				<div class="col-3 pb-2">
					<div class="bays">
						...
						<div style="padding: 20px">
							...
							<?php if ($headertrans != 'Not Found' && $headertrans['statuspr'] == '01') : ?>
								<button style="width: 100%; margin-top: 20px" class="btn btn-primary" id="addorder" onclick="addorder();">Ubah Request</button>
								<button style="width: 100%; margin-top: 3px" class="btn btn-warning" id="delorder" onclick="delorder();">Status Cancel Request</button>
								<button style="width: 100%; margin-top: 3px" class="btn btn-danger" id="cancelorder" onclick="cancelorder();">Batal Ubah</button>
...
<script type="text/javascript">
	...
	function add_row_transaksi(xxid) {
		...
		tabel += '<td style="border:none"height:1px"><input style="width:50px;text-align:right" readonly type="text" id="transaksi_' + xid + '_nourut"  class="form-control nourut" name="transaksi_' + xid + '_nourut" objtype="nourut" /><input type="hidden" id="transaksi_' + xid + '_iditem"  class="form-control iditem" name="transaksi_' + xid + '_iditem" /></td>';
		...
		tabel += '<td style="border:none"height:1px"><input style="width:200px" type="text" class="form-control sku" objtype="sku" id="transaksi_' + xid + '_sku" name="transaksi_' + xid + '_sku" placeholder="Search" list="xitem" value=""></td>';
	...
	$('form button').on("click", function(e) {
		if ($(this).attr('id') == 'cancelorder') {
			...
			if (confirm("Cancel Status Request?")) {
				delorder();
			}
		}
