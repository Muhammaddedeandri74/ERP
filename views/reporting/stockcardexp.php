        ...
        <div class="card-header border-0 bg-transparent">
            <div class="row d-flex justify-content-between">
                <div class="col-10 pl-5">
                    ...
                    <a href="<?= base_url('reporting/stockcardexp') ?>" class="btn fw bay btn-light px-4">SEGERA EXPIRED</a>
            ...
            <center>
                <div class="card bay p-4" width="80%">
                    <div class="card-header border-0 bg-white">
                        <form action="<?php echo base_url('reporting/stockcardexp') ?>" method="post">
                                ...
                                <div class="col-6" style="margin-left: 1vw;">
                                    ...
                                    <div class="card">
                                        <div class="card-body bays">
                                            ...
                                            &nbsp;
                                            <div class="input-group">
                                                <a href="<?php echo base_url('reporting/stockcardexp') ?>" style="text-decoration: none;" class=" btn btn-outline-danger">Reset</a>&nbsp;
                                        ...
                                        <?php foreach ($data as $key) : ?>
                                            ...
                                            <?php if ($ok != 0) : ?>
                                                <?php if ($a % 2 == 0) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <th style="text-align:center;width: 4%;padding-left: 1vw" scope="row"><?= $a++ ?>
                                                    </th>
...
<div class="data" id="data" style="display: none">
    <table class="table">
        <thead style="background: purple">
            <tr>
                <th style="text-align:center;border:1px solid;background-color: yellow;" scope="col">#</th>
                ...
                <th style="text-align:center;border:1px solid;background-color: yellow;" scope="col">QTY</th>
                <th style="text-align:center;border:1px solid;background-color: yellow;" scope="col">HPP</th>
                <table class="table">
                    <tbody>
                        <tr>
                            <td>EXP DATE</td>
...
<form action="<?php echo base_url('Reporting/mailstockcardexp') ?>" method="post">
