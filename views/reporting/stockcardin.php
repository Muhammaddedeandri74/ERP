...
<div class="container-xxl pb-2 pt-1" style="padding-left: 6vw;background-color : #3C2E8F">
	<p class="text-white font-weight-bold py-2 pl-2" style="font-size: 13px">WAREHOUSE / Inventory In Book</p>
	<p class="text-white font-weight-bold pl-2" style="font-size: 25px">INVENTORY IN BOOK</p>
</div>
		...
		<div class="card-header border-0 bg-transparent">
			<div class="row d-flex justify-content-between">
				<div class="col-10 pl-5">
					<a href="<?= base_url('reporting/stockcardin') ?>" class="btn bay fw btn-transparent">INVENTORY IN BOOK</a>
					<a href="<?= base_url('reporting/stockcardout') ?>" class="btn fw btn-transparent">INVENTORY OUT BOOK</a>
				</div>
				<div class="col-2">
				</div>
			</div>
...
<script language="javascript">
	$('#loadbtn').on("click", function(e) {
		window.location.href = "<?php echo base_url('reporting/stockcardin') ?>?date1=" + $('#date1').val() + "&date2=" + $('#date2').val() + "&cari=" + $('#cari').val() + "&sku=" + $('#sku').val() + "&codewh=" + $('#codewh').val() + "";
	});
