            ...
            <center>
                <div class="card bay p-4" width="80%">
                    <div class="card-header border-0 bg-white">
                        <form action="<?php echo base_url('reporting/stockcard') ?>" method="post">
                                ...
                                <div class="col-6" style="margin-left: 1vw;">
                                    ...
                                    <div class="card">
                                        <div class="card-body bays">
                                            ...
                                            &nbsp;
                                            <div class="input-group">
                                                <a href="<?php echo base_url('reporting/stockcard') ?>" style="text-decoration: none;" class=" btn btn-outline-danger">Reset</a>&nbsp;
                        ...
                        <table class="table m-0 table-striped table-hover">
                            <thead style="background-color: orange;color: white">
                                <tr>
                                    ...
                                    <!-- <th style="text-align:center;width: 5%" scope="col">QTY Selisih</th> -->
                                    <th style="text-align:center;width: 5%" scope="col">Amont HPP</th>
                                            ...
                                            <?php if ($a % 2 == 0) { ?>
                                                ...
                                                ?>
                                                    ...
                                                    <?php foreach ($key["data"] as $keyx) :
                                                        if (!isset($keyx["endqty"])) {
                                                            echo '<script>console.log(' .  json_encode($key["data"])  . ')</script>';
                                                        }

                                                    ?>
                                                        <?php if ($keyx["endqty"] != 0 && isset($keyx["endqty"])) : ?>
                                                        ...
                                                        <?php if ($data1 != "Not Found") : ?>
                                                            ...
                                                            <?php foreach ($data1 as $keey) : ?>
                                                                ...
                                                                if ($key["usesn"] == "Y") {
                                                                    ...
                                                                    if (in_array($keey1["iditem"], $iditem)) {
                                                                        ...
                                                                        if ($keey["idsn"] == $keey["idsn2"] || $keey["idsn2"] == 0) {
                                                                            if ($keey["idsn"] == $keey1["idsn"] && $keey["idsn"] < $keey1["idsn2"] && $keey["snid"] == $keey1["snid"]) {
                                                                                ...
                                                                                $g["hpps"] = 1;
                                                                                if (intval($g["snakhir"]) != "0"  && $g["snawal"] != "0") {
                                                                                    $g["hpp"] = intval($keey1["hargabeli"]) * ((intval($g["snakhir"]) - $g["snawal"]) + 1);
                                                                                    $g["selisih"] = ((intval($g["snakhir"]) - intval($g["snawal"])) + 1);
                                                                                } else {
                                                                                    $g["hpp"] = intval($keey1["hargabeli"]) * $key["qtyawal"];
                                                                                    $g["selisih"] = $key["qtyawal"];
                                                                                }
                                                                                $g["idpo"] = $keey1["idpo"];
                                                                                $g["snid"] = $keey1["snid"];
                                                                                ...
                                                                                foreach ($data1 as $keyc) {
                                                                                    if ($keey1["snid"] == $keyc["snid"]) {
                                                                                        if ($g["snawal"] >= $keyc["idsn"] && intval($g["snakhir"]) <= $keyc["idsn"]) {
                                                                                            $out++;
                                                                                        }
                                                                                    }
                                                                                }
                                                                                foreach ($key["detail"] as $keyc) {
                                                                                    if ($keey1["snid"] == $keyc["snid"]) {
                                                                                        if ($g["snawal"] >= $keyc["snawal"] && intval($g["snakhir"]) <= $keyc["snakhir"]) {
                                                                                            $out++;
                                                                                        }
                                                                                    }
                                                                                }
                                                                            ...
                                                                            if ($keey["idsn"] == $keey1["idsn"] && $keey["idsn2"] < $keey1["idsn2"] && $keey["snid"] == $keey1["snid"]) {
                                                                                ...
                                                                                foreach ($data1 as $keyc) {
                                                                                    if ($keey1["snid"] == $keyc["snid"]) {
                                                                                        if ($g["snawal"] >= $keyc["idsn"] && intval($g["snakhir"]) <= $keyc["idsn2"]) {
                                                                                            $out++;
                                                                                        }
                                                                                    }
                                                                                }
                                                                        ...
                                                                        $g["hpps"] = 1;
                                                                        if (intval($g["snakhir"]) != "0"  && $g["snawal"] != "0") {
                                                                            $g["hpp"] = intval($keey1["hargabeli"]) * ((intval(intval($g["snakhir"])) - intval($g["snawal"])) + 1);
                                                                            $g["selisih"] = ((intval($g["snakhir"]) - intval($g["snawal"])) + 1);
                                                                        } else {
                                                                            $g["hpp"] = intval($keey1["hargabeli"]) * $key["qtyawal"];
                                                                            $g["selisih"] = $key["qtyawal"];
                                                                    ...
                                                                    $g["hpp"] = intval($keey1["hargabeli"]) * intval($key["qtyawal"]);
                                                                    $g["selisih"] = intval($key["qtyawal"]);
                                                                    $g["hpps"] = 11;
                                                                    $g["snid"] = $keey1["snid"];
                                                                    $g["idpo"] = $keey1["idpo"];
                                                                    array_push($key["detail"], $g);
                                                ...
                                                if (count($key["detail"]) == 0) {
                                                    ...
                                                    foreach ($key["detail"] as $kex) {
                                                        ...
                                                        // $key["selisih"] = $kex["hpps"];

                                                        array_push($key["selisih"], $kex["selisih"]);
                                                    }

                                                    // $key["hpp"] = $totalhpp / count(array_unique($totalpo));
                                                    $key["hpp"] = $totalhpp;
                                                    // echo "<script> console.log(" . print_r($key["selisih"]) . ")</script>";
                                                }
                                                ...
                                                <!-- <td style="text-align:center;width: 5%"><?php echo  $key["selisih"] ?></td> -->
    ...
    <table class="table">
        <thead style="background: purple">
            <tr>
                ...
                <th style="text-align:center;border:1px solid;background-color: yellow;" scope="col">Min. Stock</th>
                <th style="text-align:center;border:1px solid;background-color: yellow;" scope="col">QTY Actual</th>
                <th style="text-align:center;border:1px solid;background-color: yellow;" scope="col">Avg. Prch. Price</th>
                <th style="text-align:center;border:1px solid;background-color: yellow;" scope="col">QTY Expired</th>
                <th style="text-align:center;border:1px solid;background-color: yellow;" scope="col">Balance</th>
                ...
                <?php foreach ($getdata as $key) : ?>
                    <?php if ($a % 2 == 0) { ?>
                        ...
                        if ($key["data"] != "Not Found") :  ?>
                            ...
                            <?php endforeach ?>
                        <?php endif ?>
                        <th style="border:1px solid;text-align:center;width: 4% " scope="row"><?php echo $key["iditem"] ?></th>
                        <td style="border:1px solid;text-align:center;width: 21%"><?php echo $key["nameitem"] ?></td>
                        <td style="border:1px solid;text-align:center;width: 10%"><?php echo $key["sku"] ?></td>
                        <td style="border:1px solid;text-align:center;width: 5%"><?php echo $key["minstock"] ?></td>
                        <td style="border:1px solid;text-align:center;width: 5%"><?php echo $key["qtyactual"] ?></td>
                        <td style="border:1px solid;text-align:center;width: 5%"><?php echo $key["qtyso"] ?></td>
                        <td style="border:1px solid;text-align:center;width: 5%"><?php echo $key["qtyactual"] - $key["qtyso"]   ?></td>
                        <td style="border:1px solid;text-align:center;width: 5%"><?php echo $key["hpp"] ?></td>
