...
<div class="container-xxl pt-4" style="padding-left: 6vw;background-color: orange;">
    <div class="row d-flex justify-content-between">
        <div class="col-6">
            <p class="tu font-weight-bold" style="font-size: 13px">Gudang Utama / Terbaru</p>
            <p class="tu font-weight-bold" style="font-size: 25px">Gudang Utama</p>
        </div>
        <div class="col-6">
            <div class="mb-3 row">
                <label for="inputPassword" class="col-sm-3 col-form-label text-white" style="text-align:right">Filter Pencarian</label>
                <div class="col-sm-9">
                    <input type="text" style="border: 2px solid white" oninput="searchx(this.value)" placeholder="Cari Berdasarkan Customer atau lainnya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#xF002;" class="form-control col-8 fontAwesome bg-transparent text-white" id="inputPassword">
                </div>
            </div>
        </div>
        <div class="col-8">
