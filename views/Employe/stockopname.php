        ...
        <div class="card-header border-0 bg-transparent">
            <div class="row d-flex justify-content-between">
                <div class="col-10 pl-5">
                    ...
                    <a href="<?= base_url('CounterController/opname') ?>" class="btn fw bay btn-light">STOCK OPNAME</a>
                </div>
            </div>
        </div>
            ...
            <center>
                <div class="card bay p-4" width="80%">
                    <div class="card-header border-0 bg-white">
                        <form action="<?php echo base_url('CounterController/opname') ?>" method="post">
                                ...
                                <div class="col-6" style="margin-left: 1vw;">
                                    ...
                                    <div class="card">
                                        <div class="card-body bays">
                                            ...
                                            &nbsp;
                                            <div class="input-group">
                                                <a href="<?php echo base_url('CounterController/opname') ?>" style="text-decoration: none;" class=" btn btn-outline-danger">Reset</a>&nbsp;
                    ...
                    <form action="<?php echo base_url('CounterController/addstockopname') ?>" method="post">
                        <div class="card-body ">
                                        ...
                                        <?php if ($data != "Not Found") : $a = 1;
                                            ...
                                            <?php foreach ($data as $key) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="qtyactual[]" value="0">
                                                    <input type="hidden" name="balancesystem[]" value="<?php echo $key["qtyactual"] ?>">
                                                    ...
                                                    <?php if (isset($long)) { ?>
                                                        ...
                                                        <?php endforeach ?>
                                                    <?php } else { ?>
                                                        <td class="pl-5" style="text-align:center;width: 5% "><input type="number" min="0" id="num-<?= $angka ?>" oninput="calc(this.value,<?= $angka ?>)" name="qtyactual[]" value="<?php echo 0 ?>" class="form-control bg-transparent" readonly></td>
                    ...
                    <form action="<?php echo base_url('CounterController/sentemailstockopname') ?>" method="post">
                        <div class="modal fade" id="kirimmail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" name="submit" value="Kirim" class="btn btn-warning" style="float: left;color: white;background: orange">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<form action="<?php echo base_url('CounterController/opname') ?>" method="POST" id="forms">
                ...
                <?php foreach ($data as $key) : ?>
                    ...
                    <tr>
                        ...
                        if (isset($long)) { ?>
                            <?php foreach ($long as $keyx) : ?>
                                <?php if ($keyx->SKU == $key["sku"]) : ?>
                                    <td class="pl-5" style="text-align:center;width: 5% "><?php echo $keyx->{'QTY Actual'} ?></td>
                                    <td class="pl-5" style="text-align:center;width: 5% "><?php echo $key["qtyactual"] -  $keyx->{'QTY Actual'} ?></td>
                                <?php endif ?>
                            <?php endforeach ?>
                        <?php } else { ?>
                            <td class="pl-5" style="text-align:center;width: 5% "><?php echo $key["qtyactual"] ?>></td>
                            <td class="pl-5" style="text-align:center;width: 5% "><?php echo $key["qtyactual"]  ?></td>
                        <?php } ?>
                    </tr>
                <?php array_push($getdata, $key);
