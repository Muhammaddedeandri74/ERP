          ...
          <div class="submenu">
            ...
            <div class="menu-block">
              ...
              <ul>
                ...
                <a href="<?php echo base_url('InOut/movewh') ?>">
                  <li>
                    <p>Pindah Gudang</p>
                  </li>
                </a>
                <a href="<?php echo base_url('InOut/paket') ?>">
                  <li>
            ...
            <div class="menu-block">
              ...
              <ul>
              <a href="<?php echo base_url('reporting/stockcardin') ?>">
                  <li>
                    <p>Inventory In Book</p>
                  </li>
                </a>
                ...
                <a href="<?php echo base_url('reporting/stockcard') ?>">
                  <li>
                    <p>Kartu Stock</p>
                  </li>
                </a>
            ...
            <div class="menu-block">
              ...
              <ul>
              <a href="<?php echo base_url('reporting/bookpr') ?>">
                  <li>
          ...
          <div class="submenu">
            ...
            <div class="menu-block">
              ...
              <ul>
                ...
                <a href="<?php echo base_url('CounterController/report') ?>">
                  <li>
                    <p>Reports</p>
                  </li>
                </a>
        ...
        <?php } ?>  
          ...
          <div class="submenu">
            ...
            <div class="menu-block">
              <h3 class="list-menu-title">MANAGEMENT</h3>
              <ul>
                <a href="<?php echo base_url('reporting/bookpo') ?>">
                  <li>
