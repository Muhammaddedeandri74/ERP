                ...
                <div class="card bays">
                    ...
                    <div class="card-body">
                        <div class="row d-flex justify-content-between">
                            ...
                            <div class="col-4" style="line-height: 0.6rem;">
                                <div class="input-group flex-nowrap">
                                    <p class="col-sm-4 " style="text-align: right;">TO :</p>
                                    <p class="">PT. DRS</p>
                                </div>
                                <div class="input-group flex-nowrap">
                                    <p class="col-sm-4 " style="text-align: right;">ALAMAT :</p>
                                    <p class="">Jl. Asia Tenggara sebelah timur sedikit 12112</p>
                                </div>
                            </div>
                            <div class="col-4" style="line-height: 0.6rem;">
                                <div class="input-group flex-nowrap">
                                    <p class="col-sm-4 " style="text-align: right;">No.INVOICE :</p>
                                    <p class="">Sj14045</p>
                                </div>
                                <div class="input-group flex-nowrap">
                                    <p class="col-sm-4 " style="text-align: right;">NO.ORDER :</p>
                                    <p class="">S14045</p>
                                </div>
                                <div class="input-group flex-nowrap">
                                    <p class="col-sm-4 " style="text-align: right;">DATE :</p>
                                    <p class="">21/12/2021</p>
                                </div>
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col">
                                <p class="mdc"> <u style="2px solid black">INVOICE</u> </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row d-flex justify-content-between mt-3" style="padding-bottom: 20vh;">
                            <div class="col-3"></div>
                            <div class="col-3">
                                <p>DITERIMA OLEH,</p><br><br>
                                <p>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)</p>
                            </div>
                            <div class="col-3">
                            </div>
