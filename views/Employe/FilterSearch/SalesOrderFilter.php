...
<div class="row d-flex pb-3 justify-content-between" style="padding-left: 6vw">
    <?php echo form_open('Employe/searchsalesorder'); ?>
    <div class="col-6" style="margin-left: 1vw;">
        <div class="input-group">
            <select class="form-select form-control col-3" style="background-color: purple;color: white" aria-label="Default select example" id="search">
                <option class="slc" value="1">No. Order</option>
                <option class="slc" value="2">No. Pesanan</option>
                <option class="slc" value="3">Tipe Order</option>
                <option class="slc" value="4">Nama Pemesan</option>
                <option class="slc" value="5">Alamat Pemesan</option>
            </select>
            <input type="text" name="key" class="form-control col-10" placeholder="&#xF002; Cari Berdasarkan Filter" style="font-family:Arial, FontAwesome">
        </div>
        <div class="card">
            <div class="card-body bays">
                <div class="d-flex justify-content-between">
                    <div class="col-3">
                        <p>Dari</p>
                        <input placeholder="Pilih Tanggal" style="cursor: pointer;" class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date1">
                    </div>
                    <div class="col-3">
                        <p>Hingga</p>
                        <input placeholder="Pilih Tanggal" style="cursor: pointer;" class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date2">
                    </div>
                    <div class="col-3">
                        <p>Sorting</p>
                    ...
                    <div class="col-3">
                        ...
                        <button type="submit" name="search" style="text-decoration: none" class="btn btn-outline-primary">Apply</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="data" id="data">
    <table class="table table-striped table-hover">
        <thead style="background: purple">
            <tr>
                <th style="border:solid;background-color:green">No.Order</th>
                <th style="border:solid;background-color:green">No.Pesanan</th>
                <th style="border:solid;background-color:green">Tgl.Buat</th>
                <th style="border:solid;background-color:green">Tipe Order</th>
                <th style="border:solid;background-color:green">Nama Pemesan</th>
                <th style="border:solid;background-color:green">Alamat Pemesan</th>
                <th style="border:solid;background-color:green">Qty</th>
                <th style="border:solid;background-color:green">Total Amount</th>
                <th style="border:solid;background-color:green">Deliv. Date</th>
            ...
            if (data[i]["idso"] == x) {
                ...
                for (var a = 0; a < data[i]["data"].length; a++) {
                    baris += `<tr>
								<td >` + data[i]["data"][a]["nameitem"] + `</td>
								<td >` + data[i]["data"][a]["sku"] + `</td>
								<td >` + formatnum(parseFloat(data[i]["data"][a]["pricebuyitem"]).toFixed(0)) + `</td>
