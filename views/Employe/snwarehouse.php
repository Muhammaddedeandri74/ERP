...
<div class="container-fluid py-2" style="padding-left: 6vw;background-color : orange">
    <p class="text-white font-weight-bold py-2 pl-2" style="font-size: 13px">Gudang Utama / Serial Number</p>
                            ...
                            if ($sn == "" || $item == "Not Found") {
                                        ...
                                        ?>
                                                <?php for ($i = 0; $i <= $totalsn; $i++) { ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;width: 5% "><?php echo (string)$snfix   ?></td>
                                ...
                                foreach ($item as $items) :
                                    ...
                                    if ($data3 != "Not Found") {
                                        ...
                                        foreach ($data3 as $key3) :
                                            if ($key3["idsn"] == $key3["idsn2"] || $key3["idsn2"] == 0) {
                                                if ($key3["idsn"] == ($sn) && $items['iditem'] == $key3['iditem']) {
                                                    $status = $key3["type"];
                                                }
                                            } else {
                                                if ($key3["idsn"] <= ($sn) && $key3["idsn2"] >= ($sn) && $items['iditem'] == $key3['iditem']) {
                                                    $status = $key3["type"];
                                                }
                                            }
                                            if ($status == "") {
                                ...
                                ?>
                                    <?php  ?>
                                <?php
                                    $f["iditem"] = $items["iditem"];
                                    $f["sku"] = $items["sku"];
                                    $f["nameitem"] = $items["nameitem"];
                                    $f["expdate"] = $items["expdate"];
                                    $snfix = $sn;
                                    $sndepan = substr($sn, 0, 5);
                                    $snakhirs = substr($sn, 6, (int)strlen($sn) - 2);
                                    $snakhir = substr($sn, -1);
                                    $f["idsn"] = $snfix;
                                    $f["namesupp"] = $items["namesupp"];
                                    $f["namecomm"] = $items["namecomm"];
                                    $f["priceitem"] = $items["priceitem"];
                                    $f["status"] = $status;
                                    array_push($datadisplay, $f);
                                endforeach;
                                ?>
...
<script type="text/javascript">
    ...
    function reset() {
        ...
        window.location.replace("<?php echo base_url('CounterController/snwarehouse') ?>" + '?start=' + start + '&finish=' + finish + '&page=' + page);
    }
    ...
    function page(x, y, z) {
        ...
        if ($('#date1').val() != "" && $('#date2').val() != "") {
            ...
            window.location.replace("<?php echo base_url('CounterController/snwarehouse') ?>" + '?start=' + x + '&finish=' + y + '&page=' + z + '&date1=' + $('#date1').val() + '&date2=' + $('#date2').val() + '&xxx=' + $('#selitem').val());

        } else if ($('#selitem').val() != "") {
            window.location.replace("<?php echo base_url('CounterController/snwarehouse') ?>" + '?start=' + x + '&finish=' + y + '&page=' + z + '&xxx=' + $('#selitem').val());
        } else {
            window.location.replace("<?php echo base_url('CounterController/snwarehouse') ?>" + '?start=' + x + '&finish=' + y + '&page=' + z);
        }
    ...
    input.addEventListener("keyup", function(event) {
        ...
        if (event.keyCode === 13) {
            ...
            if ($('#search').val() == "") {
                ...
                window.location.replace("<?php echo base_url('CounterController/snwarehouse') ?>" + '?start=' + start + '&finish=' + finish + '&page=' + page + '&idsn=' + $('#search').val());
            }
        }
    });
    ...
    function date() {
        ...
        if ($('#date1').val() != "" && $('#date2').val() != "") {
            ...
            window.location.replace("<?php echo base_url('CounterController/snwarehouse') ?>" + '?start=' + start + '&finish=' + finish + '&page=' + page + '&date1=' + $('#date1').val() + '&date2=' + $('#date2').val() + '&xxx=' + $('#selitem').val());

        } else if ($('#selitem').val() != "") {
            window.location.replace("<?php echo base_url('CounterController/snwarehouse') ?>" + '?start=' + start + '&finish=' + finish + '&page=' + page + '&xxx=' + $('#selitem').val());
        } else {
