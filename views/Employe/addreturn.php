                    ...
                    <div class="row d-flex justify-content-between">
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="codeso" name="codeso" placeholder="Sales Order Code" list="xpo" value="" readonly>
                            </div>
                            <div class="mb-3">
                                <label>Gudang</label>
                ...
                <div class="col-3 pb-2">
                    <div class="bays">
                        ...
                        <div style="padding: 20px">
                            ...
                            <button style="background: orange; width: 100%; color: white; margin-top: 5px" class="btn btn-warning" id="addorder">Buat Transaksi</button>
...
<script type="text/javascript">
    ...
    function add_row_transaksi(xxid) {
        ...
        tabel += '<td style="border:none"height:1px"><input type="text" class="form-control "  id="transaksi_' + xid + '_sku" name="transaksi_' + xid + '_sku"  readonly></td>';
    ...
    function ceksn(v) {
        ...
        if ($('#transaksi_' + v + '_idsn').val() != "" && $('#transaksi_' + v + '_idsn2').val() != "") {
            $.ajax({
                ...
                data: 'snno1=' + $('#transaksi_' + v + '_idsn').val() + '&snno2=' + $('#transaksi_' + v + '_idsn').val() + '&idso=0',
                dataType: "json",
