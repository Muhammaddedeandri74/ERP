				...
				<div style="margin-top: 20px" style="width: 80%">
					...
					<div class="d-flex" style="margin-top: 10%">
						...
						<div style="margin-left: 50px;">
							...
							<select class="form-control" style="width: 20vw" name="cur" required>
					...
					<div class="d-flex" style="margin-top: 10%">
						...
						<div style="margin-left : 20%">
							...
							<input type="text" class="form-control" style="width: 20vw" name="norek" required>
					...
					<div class="d-flex" style="margin-top: 10%">
						...
						<div style="margin-left: 20%;">
							...
							<input type="date" name="delivdate" class="form-control" style="width: 20vw" required>
							<p style="margin-bottom: 0; margin-top: 20px">Alamat</p>
							<input type="text" name="delivaddr" class="form-control" required>
						</div>
					</div>
					...
					<div class="d-flex" style="margin-top: 10%; margin-bottom: 10%">
						...
						<div style="margin-left: 20%;">
							...
							<input type="date" name="expquo" class="form-control" style="width: 20vw" required>
